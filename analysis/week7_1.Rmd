...
```{r}
perch <- read.csv("D:/UABC/II_Semestre/Datos_R/week7/data/YPerchTL.csv")
...
grid(lty = 1) 
points(log10(weight) ~ log10(length), data=perch, 
       col = "red", bg = "pink", pch = 24) # bg changes the fill color
...
a + labs(x = "Length (log mm)", y = "Weight (log g)")
